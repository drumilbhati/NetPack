...
INDEX_MAPPING = {
    "mappings": {
        "properties": {
            ...
            "ftp_command": {"type": "keyword"},
            "smtp_command": {"type": "keyword"},
            "smb_command": {"type": "keyword"},
            "payload_signatures": {"type": "keyword"},
...
def normalize_record(record: Any, context: dict[str, Any]) -> dict[str, Any]:
    ...
    normalized = {
        ...
        "http_host": record.get("http_host"),
        "tls_sni": record.get("tls_sni") or record.get("sni"),
        "dns_query": record.get("dns_query"),
        "ftp_command": record.get("ftp_command"),
        "smtp_command": record.get("smtp_command"),
        "smb_command": record.get("smb_command"),
        "payload_signatures": record.get("payload_signatures"),
