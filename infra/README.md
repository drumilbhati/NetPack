...
Create a case, upload real evidence through the API, then confirm the resulting case, evidence, and indexed flow records appear in PostgreSQL and Elasticsearch. The dashboard, graph, timeline, and search views all read from those live records.
